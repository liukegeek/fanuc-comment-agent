...
public class ParseHtml {
     ...
     */
    public List<DigitalComment> getDigitalComments() {
        logger.info("进入ParseHtml对象的getDigitalComments程序");
        List<DigitalComment> commentList = new ArrayList<>();
...
//            System.out.println(colName);
            ...
            trs.forEach(
                    tr -> {
                        ...
                        DigitalComment diComment = new DigitalComment(Integer.parseInt(diCommentName.substring(10)), diCommentValue); //通过name与value信息构造长文本对象。
...
//                        diComment.setComment("");  //用于制造 空的长文本
                        ...
                        DigitalComment doComment = new DigitalComment(Integer.parseInt(doCommentName.substring(10)), doCommentValue);
